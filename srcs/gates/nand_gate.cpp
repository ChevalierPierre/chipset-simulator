...
nand_gate::nand_gate(size_t in_pin, nts::Tristate val, size_t sin_pin,
...
nts::Tristate nand_gate::compute(std::size_t pin)
{
...
void nand_gate::setLink(std::size_t pin, nts::IComponent &other,
		std::size_t otherPin)
{
	struct link	*tmp = link_pin;
...
struct pin nand_gate::getOutputPin()
{
	return (output_pin_Y);
}

void nand_gate::dump() const
{
