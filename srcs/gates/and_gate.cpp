...
and_gate::and_gate(size_t in_pin, nts::Tristate val, size_t sin_pin,
...
void and_gate::setLink(std::size_t pin, nts::IComponent &other,
		std::size_t otherPin)
{
	struct link	*tmp = link_pin;
...
struct pin and_gate::getOutputPin()
{
	return (output_pin_Y);
}

void and_gate::dump() const
{
